    ...
    return(
        <View style={styles.container}>
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <ChampRedirection label="Gérer les commentaire" targetScreen="GestionCommentaire" navigation={navigation} />
                <ChampRedirection label="Gérer les lieux" targetScreen="GestionLieux" navigation={navigation} />
